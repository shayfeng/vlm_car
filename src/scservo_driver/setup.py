...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'track_to_obj_v2= scservo_driver.track_to_obj_v2:main',
            'voice_control_track = scservo_driver.voice_control_track:main',
            'track_to_obj_v3= scservo_driver.track_to_obj_v3:main',
